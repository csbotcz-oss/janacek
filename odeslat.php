...
if (!is_file($config)) {
    ...
    odpoved(false, 'Formulář zatím není nastavený. Napište nám prosím přímo na info@chata-prasilka.cz.', 502);
}
...
if (($_POST['souhlas'] ?? '') === '') {
    $chyby[] = 'souhlas se zpracováním údajů';
}
...
$telo = "Nová poptávka z webu chata-prasilka.cz\n"
      . str_repeat('-', 46) . "\n\n"
...
try {
    ...
    odpoved(false, 'Zprávu se nepodařilo odeslat. Zavolejte nám prosím na +420 607 681 002.', 502);
}
